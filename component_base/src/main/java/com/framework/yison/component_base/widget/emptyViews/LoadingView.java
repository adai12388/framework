package com.framework.yison.component_base.widget.emptyViews;
...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_qmui_loading_view_size, dip2px(context, 40));
        mPaintColor = array.getInt(R.styleable.LoadingView_qmui_loading_view_color, Color.WHITE);
        array.recycle();
        initPaint();
    }
