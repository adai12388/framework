package com.framework.yison.component_base.constants;
...
import com.framework.yison.component_base.BuildConfig;
import com.framework.yison.component_base.R;
import com.framework.yison.component_base.arouter.RouterConfig;
import com.framework.yison.component_base.util.AppUtils;
...
public class BaseApplication extends Application{
    ...
    //static 代码段可以防止内存泄露
    static {
        Debug.startMethodTracing("yison");
        //设置全局的Header构建器
...
//        L.i("当前语言："+_UserLocale );
    ...
    public void onCreate() {
        ...
        //arouter路由初始化
        RouterConfig.init(this, com.framework.yison.component_base.BuildConfig.DEBUG);
        //bugly初始化
//        initBugly();
        //初始化leakCanary
        initLeakCanary();
