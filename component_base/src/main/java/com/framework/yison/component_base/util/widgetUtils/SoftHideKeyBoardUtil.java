package com.framework.yison.component_base.util.widgetUtils;
...
public class SoftHideKeyBoardUtil {
    ...
    private void possiblyResizeChildOfContent() { //1､获取当前界面可用高度，键盘弹起后，当前界面可用布局会减少键盘的高度
        ...
        if (usableHeightNow != usableHeightPrevious) {  //3､获取Activity中xml中布局在当前界面显示的高度
           ...
           // L.d("SoftHideKeyBoardUtil++:",""+usableHeightSansKeyboard +","+heightDifference);
           ...
           // L.d("SoftHideKeyBoardUtil+:",""+usableHeightNow +","+usableHeightPrevious +","+usableHeightSansKeyboard +","+heightDifference);
    ...
    private int computeUsableHeight() {
       ...
       // L.d("SoftHideKeyBoardUtil:",""+(r.bottom - r.top) +","+r.bottom +","+r.top);
