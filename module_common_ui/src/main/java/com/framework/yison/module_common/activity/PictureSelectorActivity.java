...
import com.framework.yison.module_common.adapter.GridImageAdapter;
import com.framework.yison.module_common.uiHelper.FullyGridLayoutManager;
                ...
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(PictureSelectorActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
