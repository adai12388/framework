...
import com.framework.yison.component_base.util.JsonUtil;
import com.framework.yison.module_common.R;
import com.framework.yison.module_common.bean.JsonBean;
...
public class JsonDataActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initJsonData() {//解析数据
         ...
         *
         * */
        String JsonData = new JsonUtil().getJson(this,"province.json");//获取assets目录下的json文件数据
